...
export default function InstagramReel({ reelUrl }) {
  ...
  const shortcode = getShortcode(reelUrl);

  if (!shortcode) {
    return (
      <div className="bg-white rounded-2xl border border-gray-200 p-8 text-center">
        <p className="text-gray-500">URL Instagram invalide</p>
      </div>
    );
  }
          ...
          <div style={{ padding: '16px' }}>
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
              >
                A post shared by @tennisuniversel
              </a>
            </p>
          </div>
        </blockquote>
